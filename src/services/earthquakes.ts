...
export async function fetchQuakes(): Promise<EarthquakeUsgsGovResponse> {
...
export async function searchQuakes(event: React.SubmitEvent): Promise<EarthquakeUsgsGovResponse> {
